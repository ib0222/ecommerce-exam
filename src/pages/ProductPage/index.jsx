    ...
    <div>
      <div class="max-w-7xl mx-auto p-6">
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
          <div class="flex">
            <div class="w-1/10 p-4">
              <div class="flex flex-col space-y-4">
                <img
                  src="https://preview.colorlib.com/theme/coloshop/images/single_1_thumb.jpg.webp"
                  class="border border-gray-200 rounded-lg"
                />
                <img
                  src="https://preview.colorlib.com/theme/coloshop/images/single_2_thumb.jpg.webp"
                  class="border border-gray-200 rounded-lg"
                />
                <img
                  src="https://preview.colorlib.com/theme/coloshop/images/single_3_thumb.jpg.webp"
                  class="border border-gray-200 rounded-lg"
                />
              </div>
            </div>
            <div class="w-1/2 p-4">
              <img
                src="https://preview.colorlib.com/theme/coloshop/images/single_2.jpg.webp"
                class="border border-gray-200 rounded-lg"
              />
            </div>
            <div class="w-1/2 p-4">
              ...
              <div class="mt-4">
                <span class="inline-block bg-yellow-400 text-white px-2 py-1 rounded-lg">
                  ★★★★☆
                </span>
              </div>
              <div class="mt-4">
